...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
        development: {
            ...
            files: {
                "testbed/talessya.css": "src/talessya.less"
            }
        },
        production: {
            options: {
                ...
                cleancss: true,
                modifyVars: {
                    fonts_prefix: '"https://jorsermar.github.io/roll20-jorsermar-sheets/Talessya/fonts/"',
                    img_prefix: '"https://jorsermar.github.io/roll20-jorsermar-sheets/Talessya/img/"',
                }
            },
            files: {
                "Talessya.css": "src/talessya.less"
            }
        }
    },
    includereplace: {
  ...
  roll20: {
      development:'testbed/talessya.css',
      production:'Talessya.css'
  },
  watch: {
      development: {
